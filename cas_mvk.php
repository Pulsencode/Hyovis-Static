<!doctype html>
<html lang="en">
<?php $page_title = 'IOC - Registration | Hyovis Technologies';
...
<body class="d-flex flex-column">
  ...
  <header id="header">
    <nav
      class="navbar navbar-expand-lg bsb-navbar bsb-navbar-hover bsb-navbar-caret bsb-tpl-navbar-float bg-primary sticky-top"
  ...
  <main id="main" class="container mt-5 pt-5">
    <div class="row justify-content-center">
      <div class="col-md-8 mt-3">
        <iframe id="responsiveIframe" src="https://docs.google.com/forms/d/e/1FAIpQLSeFv3HRkwF7xeVOgtNWUnUeMYRhZsgGtYCJuJN7xcVKv1hqgA/viewform?embedded=true" width="100%" height="2890" scrolling="no" style="border: none;">Loading…</iframe>
      </div>
    </div>
  </main>
  ...
  <footer class="footer">
    <section>
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 col-lg-3 bg-primary py-md-5 py-xxl-8">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      iframe.onload = function() {
        try {
          ...
          // MutationObserver to detect content changes inside the iframe
          const observer = new MutationObserver(() => {
            console.log("Detected change in iframe!");

            // Check if "Your response has been recorded" appears (or any submission text)
            if (iframeDoc.body.innerText.includes("Your response has been recorded")) {
              ...
              setTimeout(() => {
                window.location.href = "https://hyovis.com";
              }, 2000);
            }
          });
          ...
          console.warn("Cross-origin access blocked. Can't observe iframe content.");
    ...
    function adjustIframeHeight() {
      ...
      if (window.innerWidth <= 768) {
        iframe.style.height = "3500"; // Mobile height
      } else {
        iframe.style.height = "2500px"; // Desktop height
      }
    }
